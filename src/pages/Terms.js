...
const Terms = () => {
  return (
    <div>
      ...
      <p>Welcome to Lobuddy!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Lobuddy's Website, located at lobuddy.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Lobuddy if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Lobuddy, you agreed to use
        cookies in agreement with the Lobuddy's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Lobuddy and/or its licensors own the
        intellectual property rights for all material on Lobuddy. All
        intellectual property rights are reserved. You may access this from
        Lobuddy for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Lobuddy</li>
        <li>Sell, rent or sub-license material from Lobuddy</li>
        <li>Reproduce, duplicate or copy material from Lobuddy</li>
        <li>Redistribute content from Lobuddy</li>
      </ul>
      ...
      <p>
        ...
        Lobuddy does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Lobuddy,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Lobuddy shall not be liable for the
      ...
      <p>
        Lobuddy reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Lobuddy a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Lobuddy; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Lobuddy. Please include your name, your organization name,
      ...
      <p>
        No use of Lobuddy's logo or other artwork will be allowed for linking
